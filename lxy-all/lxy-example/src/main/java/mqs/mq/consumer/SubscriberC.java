...
public class SubscriberC implements MessageListener {
	...
	SubscriberC() throws JMSException
	{
	...
	public void onMessage(Message msg) {
		...
		try {
			System.out.println("SubscriberC " + message.getJMSDestination() + " : " + message.getText());
			message.acknowledge();
	...
	public static void main(String[] args) throws JMSException {
		...
		SubscriberC sc = new SubscriberC();
		
		sc.receiveMessage(sc, "TopicA");
		sc.receiveMessage(sc, "TopicB");
