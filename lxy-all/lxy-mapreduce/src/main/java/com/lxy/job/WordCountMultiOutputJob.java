...
import com.lxy.reduce.WordCountMultiOutputReducer;
...
public class WordCountMultiOutputJob {
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setJarByClass(WordCountMultiOutputJob.class);

        //设置Map、Combine和Reduce处理类
        job.setMapperClass(WordCountMapper.class);
        job.setCombinerClass(WordCountReducer.class);
        job.setReducerClass(WordCountMultiOutputReducer.class);

        //设置输出类型
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(LongWritable.class);

        MultipleOutputs.addNamedOutput(job, "countword", TextOutputFormat.class,
